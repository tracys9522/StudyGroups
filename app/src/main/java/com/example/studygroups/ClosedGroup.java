...
public class ClosedGroup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        closed_list.setAdapter(new FirebaseListAdapter<com.example.studygroups.Group>(getActivity(), com.example.studygroups.Group.class, android.R.layout.simple_list_item_1, closed_group_database) {// Populate view as needed
            @Override
            protected void populateView(View view, com.example.studygroups.Group g, int position) {
